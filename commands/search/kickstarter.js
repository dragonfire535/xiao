	...
	async run(msg, { query }) {
		try {
			...
			const embed = new MessageEmbed()
				...
				.addField('❯ Creation Date', moment.utc(data.created_at * 1000).format('MM/DD/YYYY h:mm:ss A'), true)
				.addField('❯ Deadline', moment.utc(data.deadline * 1000).format('MM/DD/YYYY h:mm:ss A'), true);
