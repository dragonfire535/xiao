	...
	async run(msg, { ship }) {
		try {
			...
			const embed = new MessageEmbed()
				...
				.addField('❯ Armor', `${body.base.armor} (${body.max.health} Max)`, true)
				.addField('❯ Reload', `${body.base.reload} (${body.max.health} Max)`, true)
				.addField('❯ Firepower', `${body.base.firepower} (${body.max.health} Max)`, true)
				.addField('❯ Torpedo', `${body.base.torpedo} (${body.max.health} Max)`, true)
				.addField('❯ Speed', `${body.base.speed} (${body.max.health} Max)`, true)
				.addField('❯ Anti-Air', `${body.base.anti_air} (${body.max.health} Max)`, true)
				.addField('❯ Anti-Sub', `${body.base.anti_sub} (${body.max.health} Max)`, true)
				.addField('❯ Aviation', `${body.base.air_power} (${body.max.health} Max)`, true)
				.addField('❯ Oil Cost', `${body.base.oil_usage} (${body.max.health} Max)`, true)
